                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-danger" href="<?=BASEURL;?>/kategori/hapus_kategori/<?php echo $row['id_kategori']; ?>"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                <?php 
                            } 
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?=BASEURL;?>/kategori/tambah_kategori">
            ...
            <div class="modal fade" id="kategorieditModal<?php echo $rowK['id_kategori']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?=BASEURL;?>/kategori/update_kategori">
