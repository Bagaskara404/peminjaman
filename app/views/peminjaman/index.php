...
<body class="fixed-navbar">
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <a class="btn btn-sm btn-primary" href="<?=BASEURL;?>/peminjaman/cetak_kwitansi/<?php echo $row['id_peminjaman']; ?>" target="_blank"><i class="fa fa-print"></i></a><br><br>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="container">
                        <form method="POST" action="<?=BASEURL;?>/peminjaman/tambah_peminjaman">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="buku">
                                      ...
                                      <?php 
                                      foreach ( $data['data_semua_buku'] as $rowb){
                                      ?>
            ...
            <!-- Modal Edit-->
            <?php 
            foreach ( $data['semua_peminjaman'] as $rowp){
            ...
            <div class="modal fade" id="editModal<?php echo $rowp['id_peminjaman'] ?>">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="container">
                        <form method="POST" action="<?=BASEURL;?>/peminjaman/update_peminjaman">
            ...
            <!-- Modal -->
            <?php 
            foreach ($data['semua_peminjaman'] as $rowpin){
            ?>
            <div class="modal fade" id="modalForm<?php echo $rowpin['id_peminjaman']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalFormLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?=BASEURL;?>/peminjaman/proses_jumlah">
            ...
            <div class="modal" id="statusModal<?php echo $rowpin['id_peminjaman']; ?>">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="POST" action="<?=BASEURL;?>/peminjaman/update_status">
