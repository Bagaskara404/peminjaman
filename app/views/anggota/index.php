    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $anggota['nomor_hp']; ?></td>
                                    <td><?php echo $anggota['email']; ?></td>
                                    <td><?php echo $anggota['tgl_bergabung']; ?></td>
                                    <td>
                                        <a class="btn btn-sm btn-warning" href="" data-toggle="modal" data-target="#anggotaeditModal<?php echo $anggota['id_anggota']; ?>"><i class="fa fa-cog"></i></a>
                                        <a class="btn btn-sm btn-danger" href="<?php echo BASEURL; ?>/anggota/hapus_anggota/<?php echo $anggota['id_anggota']; ?>"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?=BASEURL;?>/anggota/tambah_anggota">
            ...
            if (isset($data['anggota']) && is_array($data['anggota'])) {
                foreach ($data['anggota'] as $anggota) {
            ?>
            <div class="modal fade" id="anggotaeditModal<?php echo $anggota['id_anggota']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?=BASEURL;?>/anggota/edit_anggota">
                                <input type="hidden" name="id_anggota" value="<?php echo $anggota['id_anggota']; ?>">
                                <div class="form-group">
                                    <label for="nama">Nama Anggota</label>
                                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $anggota['nama_anggota']; ?>" placeholder="Nama Anggota">
                                </div>
                                <div class="form-group">
                                    <label for="nis">NIS Anggota</label>
                                    <input type="text" class="form-control" id="nis" name="nis" value="<?php echo $anggota['nis']; ?>" placeholder="NIS Anggota">
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Alamat Anggota</label>
                                    <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $anggota['alamat']; ?>" placeholder="Alamat Anggota">
                                </div>
                                <div class="form-group">
                                    <label for="nomorhp">Nomor HP Anggota</label>
                                    <input type="text" class="form-control" id="nomorhp" name="nomorhp" value="<?php echo $anggota['nomor_hp']; ?>" placeholder="Nomor HP Anggota">
                                </div>
                                <div class="form-group">
                                    <label for="email">Email Anggota</label>
                                    <input type="email" class="form-control" id="email" name="email" value="<?php echo $anggota['email']; ?>" placeholder="Email Anggota">
                                </div>
                                <div class="form-group">
                                    <label for="tanggal">Tanggal Bergabung Anggota</label>
                                    <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?php echo $anggota['tgl_bergabung']; ?>" placeholder="Tanggal Bergabung Anggota">
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
