    ...
    <div class="content">
        ...
        <div>
            <div class="text-center m-b-20">
                <img class="img-circle" src="<?=BASEURL;?>/<?php echo $data['admin']['foto']; ?>" width="110px" />
            </div>
            <form class="text-center" id="lock-form" action="<?=BASEURL;?>/lockscreen/proses_lockscreen" method="post">
