...
<head>
    ...
    <link href="<?= BASEURL; ?>/assets/css/user/register.css" rel="stylesheet" />
    <link href="<?= BASEURL; ?>/assets/css/user/landing.css" rel="stylesheet" />
    <link href="<?= BASEURL; ?>/assets/css/user/koleksi.css" rel="stylesheet" />
...
<body>
    ...
    <div class="main-page">
        <div class="koleksi-text">
            <h1>Selamat Datang Di Koleksi Buku Pribadimu!</h1>
        </div>
        <div class="koleksi">
            <div class="row">
                <div class="col">
        ...
        <div class="button-koleksi">
            <button class="btn-kl" a href="">Sedang Dipinjam</button>
            <button class="btn-kl" a href="">Dalam Antrean</button>
            <button class="btn-kl" a href="">Sudah Dikembalikan</button>
        </div>
    </div>
