...
<head>
    ...
    <link href="<?= BASEURL; ?>/assets/vendors/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link href="<?= BASEURL; ?>/assets/vendors/themify-icons/css/themify-icons.css" rel="stylesheet" />
    <!-- THEME STYLES-->
    <link href="<?= BASEURL; ?>/assets/css/user/landing.css" rel="stylesheet" />
...
<body>
                ...
                <div class="menu-menu">
                    ...
                    <div class="menu-menu3">
                        <span class="menu-text3"> 
                            <span><a class="link" href="<?= BASEURL;?>/user_register/index.php">Sign Up</a></span>
                        </span>
                    </div>
                    <div class="logo-home">
    ...
    <div class="container header">
        <div class="left-header">
            <div class="beranda-text">
                <h1>CARI & BACA <span>BUKU FAVORTIMU</span> DENGAN<span> MUDAH</span></h1>
            </div>
            ...
            <button class="btn-beranda">Start Now</button>
        </div>
        <div class="right-header">
            <div class="main-content">
                <img src="<?= BASEURL; ?>/assets/img/Left.svg" alt="">
            </div>
        </div>
    </div>
    <div class="container">
        <h2>Apa Yang Bisa Kamu Lakuin?</h2>
        <div class="row list-aktifitas">
            <div class="col">
                <div class="aktifitas">
                    <div class="box-icon">
                    ...
                    <h6>Cari Buku</h6>
                    <p>Temukan buku favorit sesuai personamu dengan mudah dan tepat!</p>
                </div>
            </div>
            <div class="col">
                <div class="aktifitas">
    ...
    <div class="container informasi">
        <h2> Temukan Informasi Selengkapnya!</h2>
        <div class="d-flex mt-5">

            <img src="<?= BASEURL; ?>/assets/img/Service.png" alt="">

            <div class="right-info">
                <h4>Cari buku favoritmu di Urlib!</h4>
                <p>Pernahkah kamu merasa kesulitan mencari buku favoritmu di toko buku online? Bosan dengan sistem
                    pencarian
                    yang rumit dan tidak menemukan hasil yang kamu inginkan? <br>
                    Jangan khawatir! UrLib hadir untuk membantu kamu menemukan buku favoritmu dengan mudah dan cepat!
                    <br>
                    UrLib adalah platform pencarian buku yang menyediakan berbagai fitur canggih untuk memudahkan
                    pencarian
        ...
        <div class="d-flex mt-5">
            <div class="left-info">
                <h4>Baca Buku Favoritmu
                    dengan Cepat! dan Koleksi</h4>
                <p>Bosan dengan rutinitas yang itu-itu saja?
                    Ingin merasakan petualangan seru tanpa harus meninggalkan rumah? <br>
                    Mari selami dunia penuh keajaiban melalui buku!
                    Membaca buku adalah kunci untuk membuka gerbang pengetahuan dan imajinasi..</p>
            </div>
            <!-- <div class="right-info"> -->
            <img src="<?= BASEURL; ?>/assets/img/Reading.png" alt="">
            <!-- </div> -->
        </div>
    </div>

    <div class="container rating">
        <h2>Buku Dengan Rating Terpopuler!</h2>
        <div class="row">
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        <img src="<?= BASEURL; ?>/assets/img/hujan.jpeg" alt="">
                        <h5 class="card-title">Hujan di Bulan Juni</h5>
                        <h6 class="card-subtitle mb-2 text-muted">Sapardi Djoko Dammono</h6>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of
                            the
                            card's content.</p>
                        <a href="#" class="card-link">--</a>
                        <a href="#" class="card-link">Baca Sekarang </a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        <img src="<?= BASEURL; ?>/assets/img/laskar.jpeg" alt="">
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        <img src="<?= BASEURL; ?>/assets/img/bumi.jpeg" alt="">
                        <h5 class="card-title">Pramoedya Ananta Toer</h5>
                        <h6 class="card-subtitle mb-2 text-muted">Bumi Manusia</h6>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of
                            the
                            card's content.</p>
                        <a href="#" class="card-link">--</a>
    ...
    <footer class="footer-br">
        &copy; 2024 Urlib. All rights reserved.
    </footer>
</body>
