...
<body>
    ...
    <div class="main-contentx">
        <div class="login-login">
            ...
            <div class="regis-input-field">
                <form action="" method="">
                    <div class="row">
                        <div class="col">
                            <div class="regis-input">
                                <label>Nama</label><br>
                                <input type="text" class="rgs" placeholder="Enter Your Name..."><br>
                                <label>Username</label><br>
                                <input type="text" class="rgs" placeholder="Enter Your Username..."><br>
                                <label>Email</label><br>
                                <input type="text" class="rgs" placeholder="Enter Your Email..."><br>
                            </div>
                        </div>
                        <div class="col">
                            <div class="passrg-input">
                                <label>Password</label><br>
                                <input type="text" class="rgs" placeholder="Enter Your Password..."><br>
                                <label>Konfirmasi Passowrd</label><br>
                                <input type="text" class="rgs" placeholder="Confirm Your Password..."><br>
                                <button type="submit" class="btn-rgs">Sign Up</button>
                            </div>
                        </div>
                    </div>
                </form>
